...
=======
    <div className='w-full h-[11vh]  bg-transparent dark:border-neutral-400/10 flex justify-center items-center antialiased'>
      <div className='w-[95%]  flex justify-center items-center'>
        <div className='w-[33.3%] h-[9vh] flex items-center justify-start'>
          <div className='w-full flex items-center text-success'>
            <div className='w-[6%]'>
              <svg id='logo-73' width='45' height='40' viewBox='0 0 60 40' fill='none' xmlns='http://www.w3.org/2000/svg'>
                <path
                  d='M56.25 1.25C56.25 1.94036 56.8096 2.5 57.5 2.5H58.75C59.4404 2.5 60 1.94036 60 1.25C60 0.559648 59.4404 3.49691e-06 58.75 3.49691e-06H57.5C56.8096 3.49691e-06 56.25 0.559648 56.25 1.25Z'
...
>>>>>>> 36ade5e (general ui updates)
            {/* <p className='text-[16px] text-neutral-800 ml-4    font-medium dark:text-neutral-400 '>devfinder</p> */}
          </div>
        </div>
...
=======
        <form className='w-[33.3%] font-medium ml-[2rem] h-[5vh]  flex items-center justify-between  rounded-full border dark:border-neutral-400/30'>
          <button className='w-[20%] rounded-tl-full rounded-bl-full h-full text-base-100 text-[14px] flex items-center justify-center border-r dark:border-neutral-400/30'>
            {' '}
            Jobs
            <ChevronDownIcon className='w-4 h-4 ml-[0.5rem] stroke-[1.5px]' />
          </button>
          <input className=' w-[50%]  bg-transparent rounded-lg h-full'></input>
        </form>

        <div className='w-[33.3%] h-[9vh] flex items-center justify-end'>
          ...
          <ul className='flex w-[20%] items-center justify-between text-base-100'>
>>>>>>> 36ade5e (general ui updates)
            <li className='flex'>
